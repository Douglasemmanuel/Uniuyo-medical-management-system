...
$sql=mysqli_query($con,"Update users set fullName='$fname',address='$address',RegNumber='$RegNumber',gender='$gender' where id='".$_SESSION['id']."'");
if($sql)
{
...
<div class="form-group">
		...
		<input type="text" name="RegNumber" class="form-control" required="required"  value="<?php echo htmlentities($data['RegNumber']);?>" >
														</div>
